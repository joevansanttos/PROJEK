...
<?php 
   ...
   $html ="
      <fieldset>
         <body>
            ...
            Contrato de prestação de serviços para oferta de mapeamento que entre si celebram PROJEK CONSULTORIA E TREINAMENTO doravante CONTRATADA e $empresa, Nome Fantasia $nome, pessoa jurídica de direito privado, inscrita no Cadastro Nacional de Pessoas Jurídicas sob nº CNPJ Nº $cnpj, com sede na $sede, neste ato representada pelo seu administrador, $administrador, brasileiro, empresário, casado CPF nº $cpf,  residente em $residencia denominada CONTRATANTE.
   ...
   if(insereContrato($conexao,  $empresa, $nome, $cnpj, $sede, $administrador, $cpf, $residencia, 'gestao')){?>
       <p class="alert-success">O produto foi adicionado</p>
   <?php }else{
       $msg = mysqli_error($conexao);
   ?>
       <p class="alert-danger">O produto nao foi adicionado</p>
   <?php
   }   
