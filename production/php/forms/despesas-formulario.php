<?php 
  ...
  require_once "../bancos/banco-recebimento.php";
                   ...
                   <div class="x_content">
                     <form action="../adiciona/adiciona-recebimento.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">                      
                      ...
                      <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         <select name="id_cliente" class="form-control col-md-7 col-xs-12">
                           ...
                           ?>       
                           <option value="<?=$market['id_market']?>"><?=$market['nome']?></option>
                           <?php
                           endforeach
                           ?>  
                         </select>
                      ...
                      <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         <select name="id_pagamento" class="form-control col-md-7 col-xs-12">
                           <?php                           
                           foreach ($pagamentos as $pagamento): 
                           ?>       
                           <option value="<?=$pagamento['id_pagamento']?>"><?=$pagamento['descricao']?></option>
                           <?php
                           endforeach
                           ?>  
                         </select>
