...
<?php
  $id_lead = $_GET['id'];
  $lead = buscaLeadId($conexao, $id_lead);
...
<html lang="en">
  <head>
    ...
    <title>Projek | Alterar lead</title>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_content">
                  <br />
                  <form action="../altera/altera-lead.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Empresa<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="name" name="name" required="required" class="form-control col-md-7 col-xs-12" value="<?=$market['nome']?>">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="nome"  name="nome" required="required" class="form-control col-md-7 col-xs-12" value="<?=$lead['nome']?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="email" id="email" name="email" value="<?=$lead['email']?>" required="required" class="form-control col-md-8 col-xs-12">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-sm-6 col-xs-12 col-md-2">
                        <input value="<?=$lead['tel']?>" id="tel" data-inputmask="'mask' : '(99) 99999-9999'" type="text" name="tel" data-validate-linked="tel" class="form-control col-md-2 col-xs-12" required="required">
                      </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea id="comentario" required name="comentario" class="form-control col-md-7 col-xs-12"><?=$lead['comentario']?></textarea>
                      </div>
                    </div>
                    <br>
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-md-offset-3">
                        ...
                        <input type="hidden" name="id" id="id" value="<?=$lead['id_lead']?>" />
                      </div>
                    </div>                     
                  </form>
                </div> 
