	                		 ...
	                		 <form action="../altera/altera-lead.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
	                		   <div class="item form-group">
	                		     ...
	                		     <div class="col-md-6 col-sm-6 col-xs-12">
	                		       <input readonly="readonly" type="text" id="name" name="name" required="required" class="form-control col-md-7 col-xs-12" value="<?=$market['nome']?>">
	                		     </div>
	                		   </div>
	                		   ...
	                		   <div class="item form-group">
	                		     ...
	                		     <div class="col-sm-6 col-xs-12 col-md-2">
	                		       <input value="<?=$lead['tel']?>" id="tel" data-inputmask="'mask' : '(99) 9999[9]-9999'" type="text" name="tel" data-validate-linked="tel" class="form-control col-md-2 col-xs-12" required="required">
	                		     </div>
