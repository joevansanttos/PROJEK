<?php
  ...
  $id_usuario = $usuario['id_usuario'];
	...
	$tarefa = buscaTarefaNome($conexao, $tarefa_contrato['id_tarefa']);
?>
...
<html lang="en">
	<head>
	  ...
	  <meta name="viewport" content="width=device-width, initial-scale=1">
	 	<title>Projek | Novo Relatório</title>
	          ...
	          <div class="">
	            ...
	            <div class="row">
	              <div class="col-md-12 col-sm-12 col-xs-12">
	                <div class="x_panel">
	                	<div class="x_content">
	                		<form action="../adiciona/adiciona-relatorio-tarefa.php" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
	                			<div class="item form-group">
	                			 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nome">Nome da Tarefa <span class="required">*</span>
	                			 </label>
	                			 <div class="col-md-6 col-sm-6 col-xs-12">
	                			   <input type="text" readonly="readonly" value="<?=$tarefa['nome']?>" id="n_contrato" name="n_contrato" required="required" class="form-control" >
	                			 </div>
	                			</div>
	                		  <div class="item form-group">
	                		    ...
	                		    <div class="col-md-6 col-sm-6 col-xs-12">
	                		      <textarea rows="8" id="comentario" required name="comentario" class="form-control col-md-7 col-xs-12"></textarea>
	                		    </div>
	                		  </div>
	                		  ...
	                		  <div class="form-group">
	                		    <div class="col-md-6 col-md-offset-3">
	                		      ...
	                		      <input type="hidden" name="id_tarefas_contrato" value="<?=$id_tarefas_contrato?>" />
	                		    </div>
	                		  </div>                     
	                		</form>
	                	</div>
