<?php
  ...
  $id_usuario = $usuario['id_usuario'];
	...
	$consultores = listaConsultores($conexao);
?>
...
<html lang="en">
	<head>
	  ...
	  <meta name="viewport" content="width=device-width, initial-scale=1">
	 	<title>Projek | Consultores do Projeto</title>
	          ...
	          <div class="">
	            <div class="page-title">
	              <div class="title_left">
	                <h3>Consultores para o Projeto</h3>
	              </div>
	            ...
	            <div class="row">
	              <div class="col-md-12 col-sm-12 col-xs-12">
	                <div class="x_panel">
	                	<div class="x_content">
	                		<form action="../adiciona/adiciona-consultor-projeto.php" method="get" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
	                		  <div class="item form-group ">
	                		    ...
	                		    ?>
	                		            <option value='<?=$consultor['id_usuario']?>'>
