...
(1, 6, 10, '01.01.2017', 'sassasasa', 1),
(2, 6, 10, '01.01.2018', 'sasasa', 1);
...
(40, 5, 2, 10, '01.08.2017', '28.02.2018', '123456', 'RUA SÉRGIO CARDOSO, No. 20, SALA 08, CEP: 44.245-000, CENTRO - CONCEIÇÃO DO JACUÍPE – BAHIA', 'P7GO TECNOLOGIA', '26.792.567/0001-31', 10),
(39, 7, 2, 10, '01.01.2017', '01.01.2018', '233333333333', 'R General Venâncio Flores, 481 - lj-c, Leblon - Rio de Janeiro, RJ', 'Petrobras SA', '22.222.222/2222-22', 7);
...
INSERT INTO `feedback` (`id_consultor`, `id_clientes`, `pontual`, `conhecimento`, `assiduo`, `empatia`, `n_contrato`, `id_feedback`) VALUES
(10, 39, 50, 25, 50, 50, '6666666666', 3);
...
('José Petrobras', 'joevansantos@hotmail.com', '(33) 33333-3333', 'Almoxarife', 13, 39),
...
INSERT INTO `market` (`id_market`, `razao`, `nome`, `cnpj`, `site`, `endereco`, `estado`, `cidade`, `tel`, `id_type`, `segmento`, `bairro`) VALUES
(39, 'Petrobras SA', 'Petrobras', '22.222.222/2222-22', 'petrobras.com.br', 'R General Venâncio Flores, 481 - lj-c, Leblon - Rio de Janeiro, RJ', 'PR', 'Arapongas', '43434343', 2, 'Industrial', 'Pituba'),
(40, 'P7GO TECNOLOGIA', 'P7GO', '26.792.567/0001-31', 'p7go.com.br', 'RUA SÉRGIO CARDOSO, No. 20, SALA 08, CEP: 44.245-000, CENTRO - CONCEIÇÃO DO JACUÍPE – BAHIA', 'BA', 'Conceição do Jacuípe', '719233233', 2, 'Comercial', 'Centro');
...
(7, 39, '50.00', '10000.00', '5000.00', '16.09.2017', '18.11.2017', 5, 10),
(9, 39, '100.00', '2800.00', '2800.00', '01.01.3322', '01.10.0333', 7, 10),
...
('José Petroleiro', '01.01.2212', 'Agendado', '10:33', NULL, 10, 11, 39, '(22) 22222-222_', 'joevansantos@hotmail.com'),
('WENDERSON MARTINS DE ALMEIDA', '19.09.2017', 'Agendado', '14:00', NULL, 10, 12, 40, '(71) 98233-3333', 'wenderson@p7go.com');
...
--
ALTER TABLE `consultores_lead`
  MODIFY `id_c_lead` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `consultores_prospect`
  MODIFY `id_c_prospect` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `consultores_suspect`
--
ALTER TABLE `consultores_suspect`
  MODIFY `id_c_suspect` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `departamentos_contratos`
  MODIFY `id_departamento_contrato` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `leads`
  MODIFY `id_lead` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `pos_venda`
  MODIFY `id_pos_venda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `suspects`
  MODIFY `id_suspect` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
